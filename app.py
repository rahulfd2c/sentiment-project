...
def get_reviews(url):
    ...
    api_url = "https://amazon23.p.rapidapi.com/reviews"
    querystring = {"asin": asin, "sort_by": "recent", "country": "US"}

    headers = {
        "X-RapidAPI-Key": "YOUR_API_KEY_HERE", # We will get this in Step 2!
